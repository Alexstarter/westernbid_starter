 ...
 */
class Westernbid_StarterExternalModuleFrontController extends ModuleFrontController
{
    /**
     * {@inheritdoc}
     */
...
//        $amount = $this->context->cart->getOrderTotal(true, Cart::BOTH);
        ...
        $cancel_url = $this->context->link->getModuleLink('westernbid_starter', 'cancel', ['id_order' => $orderId], true);
        $callback_url = $this->context->link->getModuleLink('westernbid_starter', 'callback', ['id_order' => $orderId], true);
        ...
        $this->setTemplate('module:westernbid_starter/views/templates/front/external.tpl');
    }
    ...
    {
        if (!Configuration::get(Westernbid_Starter::STARTER_WB_ENABLED)) {
            return false;
        }
